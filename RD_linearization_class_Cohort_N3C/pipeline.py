...
@transform_pandas(
    ...
    covid_with_RD_linearization_class=Input(rid="ri.foundry.main.dataset.1e19ff64-0c69-477c-9cec-5d6cc0e25588")
)
...
def rd_covid_linear_cohort(covid_with_RD_linearization_class):
